...
DROP TABLE IF EXISTS ZSCatalogoTipo;
...
CREATE TABLE ZSPersona(
    ...
    , IdZSCatalogoTipoPersona INTEGER NOT NULL 
    , IdZSCatalogoSexo        INTEGER NOT NULL 
    , IdZSCatalogoEstadoCivil INTEGER NOT NULL 
    ...
    , ZSFechaCreacion         DATETIME NOT NULL DEFAULT (datetime('now','localtime'))
    , ZSFechaModificacion     DATETIME
    , FOREIGN KEY (IdZSCatalogoTipoPersona) REFERENCES ZSCatalogo(IdZSCatalogo)
    , FOREIGN KEY (IdZSCatalogoSexo) REFERENCES ZSCatalogo(IdZSCatalogo)
    , FOREIGN KEY (IdZSCatalogoEstadoCivil) REFERENCES ZSCatalogo(IdZSCatalogo)
);
