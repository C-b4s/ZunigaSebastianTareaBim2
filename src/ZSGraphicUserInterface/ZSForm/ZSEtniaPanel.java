...
public class ZSEtniaPanel extends JPanel {
    // Lógica de negocio
    private ZSEtniaBL zsEtniaBL = new ZSEtniaBL();
    ...
    private void zsLoadData() {
        try {
            ...
            List<ZSEtniaDTO> lista = zsEtniaBL.zsGetAll();

            for (ZSEtniaDTO s : lista) {
    ...
    private void zsDelete() {
        try {
            ...
            if (op == JOptionPane.YES_OPTION) {
                zsEtniaBL.zsDelete(idSeleccionado);
                zsLoadData();
                zsClearForm();
            }
